//NADA MAS crear este codigo, borrar el main ya que solo puede haber uno
...
public class AltaAutomovil extends javax.swing.JFrame {
        ...
        Controladora control = new Controladora();// esta instancia hace que la GUI cuando demos al boton que corresponde llame a la logica. 1erpaso.
    ...
    @SuppressWarnings("unchecked") // Se crea solo
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
     ...
     //2 paso, cuando traigamos txt con el metodo gettext, traiga el metodo que la persona haya escrito en la ventana del programa.
     String modelo = txtModelo.getText();  
     String marca = txtMarca.getText();
     String motor = txtMotor.getText();
     String color = txtColor.getText();
     String patente = txtPatente.getText();
     int cantPuertas = Integer.parseInt(txtCantPuertas.getText());//pasar el texto a entero.
        
        //3 paso agregar el automovil, llamando a la controladora el metodo que aun no existe y ahora le creas estando en la controladora.
    ...
    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        txtModelo.setText(""); // limpar pone en vacio todos los campos
        txtMarca.setText("");
        txtMotor.setText("");
        txtColor.setText("");
        txtPatente.setText("");
...
// La funcion de las interfaces graficas son traer los datos, guardarlos en variables y pasarlo a la logica.